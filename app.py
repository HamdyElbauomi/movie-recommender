...
# Use the local image
set_background("zack-snyders-justice-league-2021-movies-superman-batman-3840x2160-4845.jpg")
...
similarity = pickle.load(open('https://github.com/HamdyElbauomi/movie-recommender/releases/download/model/similarity.pkl', 'rb'))
